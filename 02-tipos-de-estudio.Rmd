...
```{r, echo = FALSE, message = FALSE, fig.cap = "Adaptado de R. Peng: [Tukey, design thinking and better questions.](https://simplystatistics.org/posts/2019-04-17-tukey-design-thinking-and-better-questions/)", warning=FALSE}
library(tidyverse)
theme_set(theme_minimal())
...
muestra_bloqueada <- trafico_tbl |> group_by(categoria, policia) |> 
  ...
  dplyr::select(policia, tiempo_espera_min, categoria) |> 
  ungroup()
muestra_bloqueada |> count(categoria, policia) |> gt::gt()
```
