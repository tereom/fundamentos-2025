...
<div class="figure" style="text-align: center">
<img src="02-tipos-de-estudio_files/figure-html/unnamed-chunk-2-1.png" alt="Adaptado de R. Peng: [Tukey, design thinking and better questions.](https://simplystatistics.org/posts/2019-04-17-tukey-design-thinking-and-better-questions/)" width="70%" />
<p class="caption">(\#fig:unnamed-chunk-2)Adaptado de R. Peng: [Tukey, design thinking and better questions.](https://simplystatistics.org/posts/2019-04-17-tukey-design-thinking-and-better-questions/)</p>
</div>
...
```{=html}
<div id="idecheohoz" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#idecheohoz table {
  font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
}

#idecheohoz thead, #idecheohoz tbody, #idecheohoz tfoot, #idecheohoz tr, #idecheohoz td, #idecheohoz th {
  border-style: none;
}
...
#idecheohoz .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#idecheohoz .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
#idecheohoz .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
#idecheohoz .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#idecheohoz .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#idecheohoz .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#idecheohoz .gt_spanner_row {
  border-bottom-style: hidden;
}

#idecheohoz .gt_group_heading {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#idecheohoz .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#idecheohoz .gt_from_md > :first-child {
  margin-top: 0;
}

#idecheohoz .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#idecheohoz .gt_row_group_first td {
  border-top-width: 2px;
}

#idecheohoz .gt_row_group_first th {
  border-top-width: 2px;
}

#idecheohoz .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#idecheohoz .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#idecheohoz .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#idecheohoz .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#idecheohoz .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#idecheohoz .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#idecheohoz .gt_last_grand_summary_row_top {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#idecheohoz .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#idecheohoz .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#idecheohoz .gt_font_normal {
  font-weight: normal;
}

#idecheohoz .gt_font_bold {
  font-weight: bold;
}

#idecheohoz .gt_font_italic {
  font-style: italic;
}
...
#idecheohoz .gt_footnote_marks {
  font-size: 75%;
  vertical-align: 0.4em;
  position: initial;
}

#idecheohoz .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#idecheohoz .gt_indent_1 {
  text-indent: 5px;
}

#idecheohoz .gt_indent_2 {
  text-indent: 10px;
}

#idecheohoz .gt_indent_3 {
  text-indent: 15px;
}

#idecheohoz .gt_indent_4 {
  text-indent: 20px;
}

#idecheohoz .gt_indent_5 {
  text-indent: 25px;
}

#idecheohoz .katex-display {
  display: inline-flex !important;
  margin-bottom: 0.75em !important;
}

#idecheohoz div.Reactable > div.rt-table > div.rt-thead > div.rt-tr.rt-tr-group-header > div.rt-th-group:after {
...
<table class="gt_table" data-quarto-disable-processing="false" data-quarto-bootstrap="false">
  <thead>
    <tr class="gt_col_headings">
      <th class="gt_col_heading gt_columns_bottom_border gt_center" rowspan="1" colspan="1" scope="col" id="categoria">categoria</th>
      <th class="gt_col_heading gt_columns_bottom_border gt_right" rowspan="1" colspan="1" scope="col" id="policia">policia</th>
      <th class="gt_col_heading gt_columns_bottom_border gt_right" rowspan="1" colspan="1" scope="col" id="n">n</th>
    </tr>
  </thead>
  <tbody class="gt_table_body">
    <tr><td headers="categoria" class="gt_row gt_center">Fluido</td>
<td headers="policia" class="gt_row gt_right">0</td>
<td headers="n" class="gt_row gt_right">3</td></tr>
    <tr><td headers="categoria" class="gt_row gt_center">Fluido</td>
<td headers="policia" class="gt_row gt_right">1</td>
<td headers="n" class="gt_row gt_right">3</td></tr>
    <tr><td headers="categoria" class="gt_row gt_center">Típico</td>
<td headers="policia" class="gt_row gt_right">0</td>
<td headers="n" class="gt_row gt_right">3</td></tr>
    <tr><td headers="categoria" class="gt_row gt_center">Típico</td>
<td headers="policia" class="gt_row gt_right">1</td>
<td headers="n" class="gt_row gt_right">3</td></tr>
    <tr><td headers="categoria" class="gt_row gt_center">Complicado</td>
<td headers="policia" class="gt_row gt_right">0</td>
<td headers="n" class="gt_row gt_right">3</td></tr>
    <tr><td headers="categoria" class="gt_row gt_center">Complicado</td>
<td headers="policia" class="gt_row gt_right">1</td>
